...
void CCamera_CutScene::Set_NextCutScene(_wstring _wszCutSceneName, INITIAL_DATA* _pTargetPos)
{
...
void CCamera_CutScene::Initialize_CameraInfo(INITIAL_DATA* _pTargetPos)
{
	if (nullptr == m_pCurCutScene)
		return;
