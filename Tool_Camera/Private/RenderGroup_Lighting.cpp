...
HRESULT CRenderGroup_Lighting::Render(CShader* _pRTShader, CVIBuffer_Rect* _pRTBuffer)
{
    ...
    _float4x4 CamView = m_pGameInstance->Get_TransformFloat4x4(CPipeLine::D3DTS_VIEW);
    _float4x4 CamProj = m_pGameInstance->Get_TransformFloat4x4(CPipeLine::D3DTS_PROJ);
    _pRTShader->Bind_Matrix("g_CamViewMatrix", &CamView);
    _pRTShader->Bind_Matrix("g_CamProjMatrix", &CamProj);
