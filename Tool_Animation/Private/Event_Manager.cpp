...
HRESULT CEvent_Manager::Excute(const EVENT& _tEvent)
{
	...
	{
	case AnimTool::EVENT_TYPE::CREATE_OBJECT:
	{
		Excute_CreateObject(_tEvent);
	}
		break;
	case AnimTool::EVENT_TYPE::DELETE_OBJECT:
	{
		Excute_DeleteObject(_tEvent);
	}
		break;
	case AnimTool::EVENT_TYPE::LEVEL_CHANGE:
	{
		Excute_LevelChange(_tEvent);
	}
		break;
	case AnimTool::EVENT_TYPE::SET_ACTIVE:
	{
