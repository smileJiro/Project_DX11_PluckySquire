...
HRESULT CAnimTool_MainApp::Initialize()
{
	// MainApp Init
...
void CAnimTool_MainApp::Progress(_float _fTimeDelta)
{
	...
	if (FAILED(Render()))
	{
		MSG_BOX("Failed Render MainApp_ ㅆㅂ 너임?");
		return;
	}
...
void CAnimTool_MainApp::Set_EffectRG()
{
...
HRESULT CAnimTool_MainApp::Ready_RenderGroup()
{
...
HRESULT CAnimTool_MainApp::Render()
{
...
HRESULT CAnimTool_MainApp::SetUp_StartLevel(LEVEL_ID _eLevelID)
{
...
CAnimTool_MainApp* CAnimTool_MainApp::Create()
{
	CAnimTool_MainApp* pInstance = new CAnimTool_MainApp();

	if (FAILED(pInstance->Initialize()))
	{
		MSG_BOX("Failed to Created : CAnimTool_MainApp");
