...
HRESULT CLoader::Loading()
{
    ...
    {
    case AnimTool::LEVEL_STATIC:
        hr = Loading_Level_Static();
         break;
    case AnimTool::LEVEL_ANIMTOOL:
        hr = Loading_Level_AnimTool();
        break;
    }
...
HRESULT CLoader::Loading_Level_Static()
{
    ...
    if (FAILED(m_pGameInstance->Add_Prototype(LEVEL_STATIC, TEXT("Prototype_GameObject_ModelObject"),
        ...
        return E_FAIL;
    if (FAILED(m_pGameInstance->Add_Prototype(LEVEL_STATIC, TEXT("Prototype_GameObject_TestModelObject"),
        CTestModelObject::Create(m_pDevice, m_pContext))))
        return E_FAIL;
...
HRESULT CLoader::Loading_Level_AnimTool()
{
    lstrcpy(m_szLoadingText, TEXT("컴포넌트를 로딩중입니다."));
    ...
    if (FAILED(m_pGameInstance->Add_Prototype(LEVEL_ANIMTOOL, TEXT("Prototype_GameObject_Camera_Free"),
        CCamera_Free::Create(m_pDevice, m_pContext))))
        return E_FAIL;
    /* For. Prototype_GameObject_Camera_Free */
    if (FAILED(m_pGameInstance->Add_Prototype(LEVEL_ANIMTOOL, TEXT("Prototype_GameObject_Camera_Target"),
