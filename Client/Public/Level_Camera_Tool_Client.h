...
BEGIN(Client)
class CLevel_Camera_Tool_Client final : public CLevel
{
public:
...
private:
	CLevel_Camera_Tool_Client(ID3D11Device* _pDevice, ID3D11DeviceContext* _pContext);
	virtual ~CLevel_Camera_Tool_Client() = default;
...
public:
	static CLevel_Camera_Tool_Client* Create(ID3D11Device* _pDevice, ID3D11DeviceContext* _pContext, LEVEL_ID _eLevelID);
