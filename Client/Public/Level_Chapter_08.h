...
{
private:
	CLevel_Chapter_08(ID3D11Device* _pDevice, ID3D11DeviceContext* _pContext);
	virtual ~CLevel_Chapter_08() = default;
...
public:
	static CLevel_Chapter_08* Create(ID3D11Device* _pDevice, ID3D11DeviceContext* _pContext, LEVEL_ID _eLevelID);
