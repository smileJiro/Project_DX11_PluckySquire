...
BEGIN(Client)
class CLevel_Physx final : public CLevel
{
private:
	CLevel_Physx(ID3D11Device* _pDevice, ID3D11DeviceContext* _pContext);
	virtual ~CLevel_Physx() = default;
...
public:
	static CLevel_Physx* Create(ID3D11Device* _pDevice, ID3D11DeviceContext* _pContext);
