...
public:
	...
	HRESULT					Create_Objects(const _wstring& _strPoolingTag, _uint iNumPoolingObjects, _float3* _pPosition = nullptr, _float3* _pScaling = nullptr);
	HRESULT					Create_Object(const _wstring& _strPoolingTag, _float3* _pPosition = nullptr, _float3* _pScaling = nullptr);
