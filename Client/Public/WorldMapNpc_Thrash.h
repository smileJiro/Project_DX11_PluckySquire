...
private:
	CWorldMapNpc_Thrash(ID3D11Device* _pDevice, ID3D11DeviceContext* _pContext);
	CWorldMapNpc_Thrash(const CWorldMapNpc_Thrash& _Prototype);
	virtual ~CWorldMapNpc_Thrash() = default;
...
public:
	static CWorldMapNpc_Thrash*	Create(ID3D11Device* _pDevice, ID3D11DeviceContext* _pContext);
