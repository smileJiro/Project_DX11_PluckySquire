...
private:
	CWorldMapNpc_Violet(ID3D11Device* _pDevice, ID3D11DeviceContext* _pContext);
	CWorldMapNpc_Violet(const CWorldMapNpc_Violet& _Prototype);
	virtual ~CWorldMapNpc_Violet() = default;
...
public:
	static CWorldMapNpc_Violet*	Create(ID3D11Device* _pDevice, ID3D11DeviceContext* _pContext);
