...
class CBook final : public CModelObject, public IAnimEventReceiver, public IInteractable
{
public:
...
public:
	typedef struct tagBookDesc : public CModelObject::MODELOBJECT_DESC
	{
		_bool isInitOverride = false;
