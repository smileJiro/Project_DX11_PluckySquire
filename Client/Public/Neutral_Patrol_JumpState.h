...
class CNeutral_Patrol_JumpState final : public CState
{
public:
...
private:
	CNeutral_Patrol_JumpState();
	virtual ~CNeutral_Patrol_JumpState() = default;
...
public:
	static CNeutral_Patrol_JumpState* Create(void* _pArg);
