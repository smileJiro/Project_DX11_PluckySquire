...
#include "Monster.h"
BEGIN(Client)
class CSketchSpace_Alien final : public CMonster
{
public:
	enum Animation2D
	{
...
private:
	CSketchSpace_Alien(ID3D11Device* _pDevice, ID3D11DeviceContext* _pContext);
	CSketchSpace_Alien(const CSketchSpace_Alien& _Prototype);
	virtual ~CSketchSpace_Alien() = default;
...
public:
	static CSketchSpace_Alien* Create(ID3D11Device* _pDevice, ID3D11DeviceContext* _pContext);
