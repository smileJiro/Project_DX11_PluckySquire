...
void CBoss_EnergyBall::OnTrigger_Enter(const COLL_INFO& _My, const COLL_INFO& _Other)
{
    __super::OnTrigger_Enter(_My, _Other);
}

void CBoss_EnergyBall::OnTrigger_Stay(const COLL_INFO& _My, const COLL_INFO& _Other)
{
}

void CBoss_EnergyBall::OnTrigger_Exit(const COLL_INFO& _My, const COLL_INFO& _Other)
{
}
...
HRESULT CBoss_EnergyBall::Ready_ActorDesc(void* _pArg)
{
    PROJECTILE_MONSTER_DESC* pDesc = static_cast<PROJECTILE_MONSTER_DESC*>(_pArg);
