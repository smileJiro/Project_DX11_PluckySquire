...
CSection_2D_PlayMap_Book::CSection_2D_PlayMap_Book(ID3D11Device* _pDevice, ID3D11DeviceContext* _pContext)
	:CSection_2D(_pDevice, _pContext, PLAYMAP, SECTION_2D_BOOK)
{
}

HRESULT CSection_2D_PlayMap_Book::Initialize(SECTION_2D_DESC* _pDesc, _uint _iPriorityKey)
{
...
HRESULT CSection_2D_PlayMap_Book::Import(json _SectionJson, _uint _iPriorityKey)
{
...
HRESULT CSection_2D_PlayMap_Book::Add_GameObject_ToSectionLayer(CGameObject* _pGameObject, _uint _iLayerIndex)
{
	HRESULT hr = __super::Add_GameObject_ToSectionLayer(_pGameObject, _iLayerIndex);
	return hr;
}

HRESULT CSection_2D_PlayMap_Book::Section_AddRenderGroup_Process()
{
	// 텍스쳐 복사
