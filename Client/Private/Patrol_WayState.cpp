...
CPatrol_WayState::CPatrol_WayState()
{
}

HRESULT CPatrol_WayState::Initialize(void* _pArg)
{
...
void CPatrol_WayState::State_Enter()
{
	m_fAccTime = 0.f;
	m_isToWay = false;
	m_isTurn = false;
...
void CPatrol_WayState::State_Update(_float _fTimeDelta)
{
	...
	//이동
	Patrol_WayMove(_fTimeDelta, m_iDir);
}

void CPatrol_WayState::State_Exit()
{
	m_fAccTime = 0.f;
	m_fAccDistance = 0.f;
	m_isTurn = false;
...
void CPatrol_WayState::Patrol_WayMove(_float _fTimeDelta, _int _iDir)
{
...
void CPatrol_WayState::Determine_Direction()
{
...
CPatrol_WayState* CPatrol_WayState::Create(void* _pArg)
{
	CPatrol_WayState* pInstance = new CPatrol_WayState();

	if (FAILED(pInstance->Initialize(_pArg)))
	{
		MSG_BOX("Failed to Created : CPatrol_WayState");
