...
#pragma region Static - Texture Load
	...
	/* For. Prototype_Component_Texture_BackGround_Chapter6 */
	if (FAILED(m_pGameInstance->Add_Prototype(LEVEL_STATIC, TEXT("Prototype_Component_Texture_BackGround_Chapter6"),
		CTexture::Create(m_pDevice, m_pContext, TEXT("../Bin/Resources/Textures/BackGround/Chapter6.dds"), 1, true))))
		return E_FAIL;
...
#pragma region Static - Sound Load
	...
	if (FAILED(Loading_SFX_PathFind(TEXT("../Bin/Sounds/SFX/Level4"))))
		return E_FAIL;
...
HRESULT CLoader::Loading_Level_Chapter_6(LEVEL_ID _eLoadLevelID)
{
	...
	#pragma region Chapter 6 - Object Load
		...
		if (FAILED(m_pGameInstance->Add_Prototype(_eLoadLevelID, TEXT("Prototype_GameObject_Saw"),
			CSaw::Create(m_pDevice, m_pContext))))
			return E_FAIL;
...
HRESULT CLoader::Loading_Level_Chapter_8(LEVEL_ID _eLoadLevelID)
{
	...
	if (FAILED(m_pGameInstance->Add_Prototype(_eLoadLevelID, TEXT("Prototype_Component_Texture_BossShieldMain"),
		CTexture::Create(m_pDevice, m_pContext, TEXT("../Bin/Resources/Textures/Effects/T_FX_CMN_Noise_10.dds"), 1))))
		return E_FAIL;

	if (FAILED(m_pGameInstance->Add_Prototype(_eLoadLevelID, TEXT("Prototype_Component_Texture_BossShieldNoise"),
...
#pragma endregion
	...
	if (FAILED(m_pGameInstance->Add_Prototype(_eLoadLevelID, TEXT("S_FX_CMN_Sphere_03"),
		C3DModel::Create(m_pDevice, m_pContext,
			("../Bin/Resources/Models/3DAnim/Chapter8/buttergrump_Rig/Projectiles/S_FX_CMN_Sphere_03.model"
				), matPretransform))))
		return E_FAIL;
