...
HRESULT CLevel_Chapter_02::Ready_Layer_Camera(const _wstring& _strLayerTag, CGameObject* _pTarget)
{
	...
	XMStoreFloat3(&TargetDesc.vArm, XMVector3Normalize(XMVectorSet(0.f, 0.67f, -0.74f, 0.f)));
...
HRESULT CLevel_Chapter_02::Ready_Layer_NPC(const _wstring& _strLayerTag)
{
	...
	NPCDesc.iMainIndex = 0;
	NPCDesc.iSubIndex = 0;
	wsprintf(NPCDesc.strLocateSection, TEXT("Chapter2_P0304"));
	NPCDesc.vPos = _float2(858.f, 38.02f);
...
HRESULT CLevel_Chapter_02::Ready_Layer_Monster()
{
	...
	Beetle_Desc.tTransform3DDesc.vInitialPosition = _float3(31.8f, 8.58f, 24.4f);
