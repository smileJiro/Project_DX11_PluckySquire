...
CLevel_Chapter_Test::CLevel_Chapter_Test(ID3D11Device* _pDevice, ID3D11DeviceContext* _pContext)
	:
	m_eLevelID(LEVEL_CHAPTER_TEST)
...
HRESULT CLevel_Chapter_Test::Initialize(LEVEL_ID _eLevelID)
{
	...
	//if (FAILED(m_pGameInstance->Add_GameObject_ToLayer(LEVEL_CHAPTER_TEST, TEXT("Prototype_GameObject_Dice"), m_eLevelID, TEXT("Layer_Test"), &tModelDesc)))
	//	return E_FAIL;

	//if (FAILED(m_pGameInstance->Add_GameObject_ToLayer(LEVEL_CHAPTER_TEST, TEXT("Prototype_GameObject_Domino"), m_eLevelID, TEXT("Layer_Test"), &tModelDesc)))
	//	return E_FAIL;
...
HRESULT CLevel_Chapter_Test::Ready_Lights()
{
...
HRESULT CLevel_Chapter_Test::Ready_CubeMap(const _wstring& _strLayerTag)
{
...
HRESULT CLevel_Chapter_Test::Ready_Layer_MainTable(const _wstring& _strLayerTag)
{
...
HRESULT CLevel_Chapter_Test::Ready_Layer_Map()
{
...
HRESULT CLevel_Chapter_Test::Ready_Layer_Camera(const _wstring& _strLayerTag, CGameObject* _pTarget)
{
...
HRESULT CLevel_Chapter_Test::Ready_Layer_Player(const _wstring& _strLayerTag, CGameObject** _ppOut)
{
...
HRESULT CLevel_Chapter_Test::Ready_Layer_TestTerrain(const _wstring& _strLayerTag)
{
	/* Test Terrain */
...
HRESULT CLevel_Chapter_Test::Ready_Layer_UI(const _wstring& _strLayerTag)
{
	CUI::UIOBJDESC pDesc = {};
...
HRESULT CLevel_Chapter_Test::Ready_Layer_NPC(const _wstring& _strLayerTag)
{
...
HRESULT CLevel_Chapter_Test::Ready_Layer_Monster(const _wstring& _strLayerTag, CGameObject** _ppout)
{
	...
	Pooling_Desc.iPrototypeLevelID = LEVEL_STATIC;
	Pooling_Desc.strLayerTag = TEXT("Layer_Monster");
	Pooling_Desc.strPrototypeTag = TEXT("Prototype_GameObject_Spear_Soldier");
	Pooling_Desc.eSection2DRenderGroup = SECTION_2D_PLAYMAP_OBJECT;

	CSpear_Soldier::MONSTER_DESC* Spear_Soldier_Desc = new CSpear_Soldier::MONSTER_DESC;
	...
	CPooling_Manager::GetInstance()->Register_PoolingObject(TEXT("Pooling_Spear_Soldier"), Pooling_Desc, Spear_Soldier_Desc);

	vPos = { 5.5f, 0.35f, -3.0f };
	CPooling_Manager::GetInstance()->Create_Object(TEXT("Pooling_Spear_Soldier"), COORDINATE_3D, &vPos);
...
void CLevel_Chapter_Test::Create_Arm(_uint _iCoordinateType, CGameObject* _pCamera, _float3 _vRotation, _float _fLength)
{
	CGameObject* pPlayer = m_pGameInstance->Get_GameObject_Ptr(m_eLevelID, TEXT("Layer_Player"), 0);
	if (nullptr == pPlayer)
		return;
...
HRESULT CLevel_Chapter_Test::Map_Object_Create(_wstring _strFileName)
{
...
CLevel_Chapter_Test* CLevel_Chapter_Test::Create(ID3D11Device* _pDevice, ID3D11DeviceContext* _pContext, LEVEL_ID _eLevelID)
{
	CLevel_Chapter_Test* pInstance = new CLevel_Chapter_Test(_pDevice, _pContext);

	if (FAILED(pInstance->Initialize(_eLevelID)))
	{
		MSG_BOX("Failed to Created : CLevel_Chapter_Test");
