...
CChase_WayState::CChase_WayState()
{
}

HRESULT CChase_WayState::Initialize(void* _pArg)
{
...
void CChase_WayState::Set_WayPoint(SNEAKWAYPOINTINDEX _eWayIndex)
{
	Initialize_WayPoints(_eWayIndex);
}


void CChase_WayState::State_Enter()
{
	m_isTurn = false;
	m_isMove = false;
	m_isRenew = true;
...
void CChase_WayState::State_Update(_float _fTimeDelta)
{
...
void CChase_WayState::State_Exit()
{
	m_isTurn = false;
}

CChase_WayState* CChase_WayState::Create(void* _pArg)
{
	CChase_WayState* pInstance = new CChase_WayState();

	if (FAILED(pInstance->Initialize(_pArg)))
	{
		MSG_BOX("Failed to Created : CChase_WayState");
