...
CWorldMapNpc_Violet::CWorldMapNpc_Violet(ID3D11Device* _pDevice, ID3D11DeviceContext* _pContext)
	:CModelObject(_pDevice, _pContext)
{
}

CWorldMapNpc_Violet::CWorldMapNpc_Violet(const CWorldMapNpc_Violet& _Prototype)
...
HRESULT CWorldMapNpc_Violet::Initialize_Prototype()
{
	return S_OK;
}

HRESULT CWorldMapNpc_Violet::Initialize(void* _pArg)
{
	WORLDMAP_PART_Violet_DESC* pDesc = static_cast<WORLDMAP_PART_Violet_DESC*>(_pArg);
	...
	//
	//static_cast<CModelObject*>(m_PartObjects[PART_BODY])->Register_OnAnimEndCallBack(bind(&CWorldMapNpc_Violet::On_AnimEnd, this, placeholders::_1, placeholders::_2));
...
void CWorldMapNpc_Violet::Priority_Update(_float _fTimeDelta)
{
	__super::Priority_Update(_fTimeDelta);
}

void CWorldMapNpc_Violet::Update(_float _fTimeDelta)
{
...
void CWorldMapNpc_Violet::Late_Update(_float _fTimeDelta)
{
...
HRESULT CWorldMapNpc_Violet::Render()
{
	if (Is_Active())
...
void CWorldMapNpc_Violet::On_Collision2D_Enter(CCollider* _pMyCollider, CCollider* _pOtherCollider, CGameObject* _pOtherObject)
{

}

void CWorldMapNpc_Violet::On_Collision2D_Stay(CCollider* _pMyCollider, CCollider* _pOtherCollider, CGameObject* _pOtherObject)
{
	
}

void CWorldMapNpc_Violet::On_Collision2D_Exit(CCollider* _pMyCollider, CCollider* _pOtherCollider, CGameObject* _pOtherObject)
{
...
void CWorldMapNpc_Violet::On_AnimEnd(COORDINATE _eCoord, _uint iAnimIdx)
{
	
}


void CWorldMapNpc_Violet::Interact(CPlayer* _pUser)
{
	//Throw_Dialogue();
}

_bool CWorldMapNpc_Violet::Is_Interactable(CPlayer* _pUser)
{
...
_float CWorldMapNpc_Violet::Get_Distance(COORDINATE _eCoord, CPlayer* _pUser)
{
...
CWorldMapNpc_Violet* CWorldMapNpc_Violet::Create(ID3D11Device* _pDevice, ID3D11DeviceContext* _pContext)
{
	CWorldMapNpc_Violet* pInstance = new CWorldMapNpc_Violet(_pDevice, _pContext);
...
CGameObject* CWorldMapNpc_Violet::Clone(void* _pArg)
{
	CWorldMapNpc_Violet* pInstance = new CWorldMapNpc_Violet(*this);
...
HRESULT CWorldMapNpc_Violet::Cleanup_DeadReferences()
{
	return S_OK;
}
