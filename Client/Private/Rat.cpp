...
void CRat::On_Hit(CGameObject* _pHitter, _int _iDamg, _fvector _vForce)
{
...
HRESULT CRat::Ready_ActorDesc(void* _pArg)
{
    ...
    XMStoreFloat4x4(&ShapeData->LocalOffsetMatrix, XMMatrixRotationY(XMConvertToRadians(90.f)) * XMMatrixTranslation(0.0f, TriggerDesc->fRadius, 0.0f)); // Shape의 LocalOffset을 행렬정보로 저장.
