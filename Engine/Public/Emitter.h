...
public:
	...
	enum SPAWN_POSITION { RELATIVE_WORLD, ABSOLUTE_WORLD, FOLLOW_PARENT, FOLLOW_PARENT_ABSOLUTE  };
...
NLOHMANN_JSON_SERIALIZE_ENUM(CEmitter::SPAWN_POSITION, {
	...
	{CEmitter::SPAWN_POSITION::FOLLOW_PARENT, "FOLLOW_PARENT"},
	{CEmitter::SPAWN_POSITION::FOLLOW_PARENT_ABSOLUTE, "FOLLOW_PARENT_ABSOLUTE"},
	});
