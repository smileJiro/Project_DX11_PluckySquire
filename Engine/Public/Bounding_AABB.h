...
public:
	const BoundingBox* Get_FinalBoundingBox_Ptr() const { return m_pFinalBoundingBox; }
private: /* BoundingBox : AABB에 사용 될 구조체 타입 */
	BoundingBox* m_pOriginalBoundingBox;
	BoundingBox* m_pFinalBoundingBox;

public:
	static CBounding_AABB* Create(ID3D11Device* _pDevice, ID3D11DeviceContext* _pContext, const BOUND_DESC* _pBoundDesc);
	virtual void Free();
};
END
