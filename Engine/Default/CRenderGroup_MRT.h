...
BEGIN(Engine)
class CRenderGroup_MRT : public CRenderGroup
{
public:
	typedef struct tagRG_MRTDesc
	{
		_wstring strMRTTag;
		// 해상도가 달라 별도의 DSV가 필요하다면 일단 넣어두자.
...
public:
	...
	HRESULT Render(CShader* _pRTShader, CVIBuffer* _pRTBuffer) override;
