...
HRESULT CMagic_Hand::Ready_PartObjects()
{
    ...
    EffectDesc.iCurLevelID = LEVEL_TOOL;
    ...
    EffectDesc.szModelShaderTags = L"Prototype_Component_Shader_VtxModelInstance";
    EffectDesc.iEffectShaderLevel = LEVEL_STATIC;
    EffectDesc.szEffectShaderTags = L"Prototype_Component_Shader_Effect";
    ...
    EffectDesc.szSpriteComputeShaderTag = L"Prototype_ComputeShader";
    ...
    m_pEffectSystem->Set_ParentMatrix(COORDINATE_3D, m_pControllerTransform->Get_WorldMatrix_Ptr());
