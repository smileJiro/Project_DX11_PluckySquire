...
{
public:
	enum TEXTURE_TYPE { ALPHA, MASK, NOISE, SECOND, TEXTURE_END };
	enum EFFECT_SHADERPASS { DEFAULT, DEFAULT_DISSOLVE, BLOOM, BLOOM_DISSOLVE, BLOOM_DISSOLVE_BILLBOARD, DISTORTION, SUB_DISSOLVE, };
