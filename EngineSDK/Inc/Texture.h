...
public:
	static CTexture* Create(ID3D11Device* _pDevice, ID3D11DeviceContext* _pContext, const _char* _szTextureFilePath, _uint _iNumTextures = 1,_bool _isSRGB = false, _bool _isCube = false);
	static CTexture* Create(ID3D11Device* _pDevice, ID3D11DeviceContext* _pContext, const _tchar* _pTextureFilePath, _uint _iNumTextures = 1,_bool _isSRGB = false, _bool _isCube = false);
