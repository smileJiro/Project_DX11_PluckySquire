...
public:
	static CEffect_Module* Create(const json& _jsonModuleInfo);
...
public:
	static CEffect_Module* Create(MODULE_TYPE _eType, const _string& _strTypeName);
...
{CEffect_Module::MODULE_TYPE::MODULENONE, "NONE"},
{CEffect_Module::MODULE_TYPE::POINT_VELOCITY, "POINT_VELOCITY"},
{CEffect_Module::MODULE_TYPE::LINEAR_VELOCITY, "LINEAR_VELOCITY"},
{CEffect_Module::MODULE_TYPE::INIT_ACCELERATION, "INIT_ACCELERATION"},
{CEffect_Module::MODULE_TYPE::GRAVITY, "GRAVITY"},
{CEffect_Module::MODULE_TYPE::DRAG, "DRAG"},
{CEffect_Module::MODULE_TYPE::VORTEX_ACCELERATION, "VORTEX_ACCELERATION"},
{CEffect_Module::MODULE_TYPE::POINT_ACCELERATION, "POINT_ACCELERATION"},
{CEffect_Module::MODULE_TYPE::LIMIT_ACCELERATION, "LIMIT_ACCELERATION"},
